/*
 * erivers/amlogic/media/vout/backlight/aml_ldim/iw7038_bl.c
 *
...
int ldim_dev_iw7038_probe(struct aml_ldim_driver_s *ldim_drv)
{
	...
	bl_iw7038->spi = ldim_drv->spi_dev;
	...
	max_data_size = ldim_drv->ldev_conf->bl_regnum *
	...
	bl_iw7038->cls.name = kzalloc(10, GFP_KERNEL);
	sprintf((char *)bl_iw7038->cls.name, "iw7038");
	bl_iw7038->cls.class_attrs = iw7038_class_attrs;
	ret = class_register(&bl_iw7038->cls);
	if (ret < 0)
		LDIMERR("register iw7038 class failed\n");
