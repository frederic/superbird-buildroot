...
int ldim_dev_iw7027_he_probe(struct aml_ldim_driver_s *ldim_drv)
{
	...
	bl_iw7027_he->spi = ldim_drv->spi_dev;
	...
	bl_iw7027_he->cls.name = kzalloc(10, GFP_KERNEL);
	sprintf((char *)bl_iw7027_he->cls.name, "iw7027_he");
	bl_iw7027_he->cls.class_attrs = iw7027_he_class_attrs;
	ret = class_register(&bl_iw7027_he->cls);
	if (ret < 0)
		LDIMERR("register iw7027_he class failed\n");
