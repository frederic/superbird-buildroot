...
enum opt_code
{
  ...
  OPT_mapcs_float = 1185,                    /* -mapcs-float */
  OPT_mapcs_frame = 1186,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1187,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1188,              /* -mapcs-stack-check */
  OPT_march_ = 1189,                         /* -march= */
  OPT_marm = 1190,                           /* -marm */
  OPT_masm_syntax_unified = 1191,            /* -masm-syntax-unified */
