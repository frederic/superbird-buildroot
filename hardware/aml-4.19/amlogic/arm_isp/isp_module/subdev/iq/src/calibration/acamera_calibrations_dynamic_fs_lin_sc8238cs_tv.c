...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    ...
    60,      // max_str: iridix strength in percentage: 50 = 1x gain. 100 = 2x gain
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //iridix
    { 0x1ac34, 0x64000L, 0xfffff,4 }, //white_level
    //pf correction
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 150, 260, 100, 500, 8000, 8000, 4000, 4000, 8000, 8000},
    {1 * 256, 150, 128, 150, 260, 100, 500, 8000, 8000, 4000, 4000, 8000, 8000},
    {2 * 256, 150, 100, 150, 300, 100, 500, 7000, 7000, 4000, 4000, 8000, 8000},
    {3 * 256, 150, 100, 150, 300, 100, 500, 7000, 7000, 4000, 4000, 8000, 8000},
    {4 * 256, 150, 90, 150, 300, 500, 500, 7000, 7000, 4000, 4000, 8000, 8000},
    {5 * 256, 150, 90, 150, 300, 500, 500, 7000, 7000, 4000, 4000, 8000, 8000},
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    {0 * 256, 2000, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 20000, 0, 160, 20000},
    {1 * 256, 2000, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 25000, 0, 160, 25000},
    {2 * 256, 1600, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 40000, 0, 160, 40000},
    {3 * 256, 1200, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 50000, 0, 160, 50000},
    {4 * 256, 1200, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 60000, 0, 160, 60000},
    {5 * 256, 1200, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 65000, 0, 160, 65000},
    {6 * 256, 1100, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 65530, 0, 160, 65530},
    {7 * 256, 1100, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 200, 65535, 0, 160, 65530, 0, 160, 65530},
};
