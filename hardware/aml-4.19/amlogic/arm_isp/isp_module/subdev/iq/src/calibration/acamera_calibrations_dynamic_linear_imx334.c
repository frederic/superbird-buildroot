...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {5000000, 4000000}; //3574729
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    25,      // dark_prc
    95,      // bright_prc
    480,     // min_dk: minimum dark enhancement
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 170, 280, 360, 360, 7000, 7000, 4000, 4000, 8000, 8000},
    {1 * 256, 150, 128, 170, 280, 400, 400, 7000, 7000, 4000, 4000, 8000, 8000},
    {2 * 256, 150, 128, 170, 280, 400, 400, 7000, 7000, 4000, 4000, 8000, 8000},
    {3 * 256, 150, 128, 170, 300, 400, 400, 7000, 7000, 4000, 4000, 8000, 8000},
    {4 * 256, 150, 128, 170, 300, 400, 400, 7000, 7000, 4000, 4000, 8000, 8000},
    {5 * 256, 150, 128, 160, 330, 400, 400, 7000, 7000, 4000, 4000, 8000, 8000},
    {6 * 256, 150, 128, 160, 350, 450, 450, 7000, 7000, 4000, 4000, 8000, 8000},
    {7 * 256, 150, 128, 150, 350, 500, 500, 7000, 7000, 4000, 4000, 8000, 8000},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    ...
    {4 * 256, 1200, 0, 240, 50000, 0, 240, 50000, 0, 240, 50000, 0, 240, 50000, 0, 100, 50000, 0, 100, 50000},
    {5 * 256, 1200, 0, 240, 50000, 0, 240, 50000, 0, 240, 50000, 0, 240, 50000, 0, 100, 55000, 0, 100, 55000},
    {6 * 256, 1000, 0, 240, 50000, 0, 240, 50000, 0, 240, 50000, 0, 240, 50000, 0, 100, 60000, 0, 100, 60000},
