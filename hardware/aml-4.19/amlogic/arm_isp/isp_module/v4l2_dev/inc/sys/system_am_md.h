...
typedef struct {
	...
	int reg_ds_hstep;                   //u4: integer pixel ratio for horizontal scalar, o2i_ratio= 1/step, 1£þ15
    int reg_ds_vstep;                   //u4: integer pixel ratio for vertical scalar,   o2i_ratio= 1/step??1£þ15
