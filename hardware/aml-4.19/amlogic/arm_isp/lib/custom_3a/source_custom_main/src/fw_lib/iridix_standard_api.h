...
typedef void ( *iridix_std_frameid_func )( void *iridix_ctx, uint32_t frame_id );
typedef void ( *iridix_std_prev_param_func )( void *iridix_ctx, isp_iridix_preset_t * param );
...
typedef struct _iridix_std_obj_ {
    ...
    iridix_std_frameid_func frameid;
    iridix_std_prev_param_func prevparam;
} iridix_std_obj_t;
