...
typedef void ( *awb_std_frameid_func )( void *awb_ctx, uint32_t frame_id );
typedef void ( *awb_std_prev_param_func )( void *awb_ctx, isp_awb_preset_t * param );
...
typedef struct _awb_std_obj_ {
    ...
    awb_std_frameid_func frameid;
    awb_std_prev_param_func prevparam;
} awb_std_obj_t;
