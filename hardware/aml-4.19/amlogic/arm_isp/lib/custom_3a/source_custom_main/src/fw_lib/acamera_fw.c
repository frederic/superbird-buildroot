...
void acamera_3aalg_preset(acamera_fsm_mgr_t *p_fsm_mgr)
{
	...
	ae_param.skip_cnt = 5;
	ae_param.exposure_log2 = 2250000;
	ae_param.integrator = 66000000;
	...
	LOG(LOG_INFO, "ctrl_channel_3aalg_param_init: %d,%d,%d,%d,%d",ae_param.exposure_log2,\
		ae_param.integrator,ae_param.error_log2,iridix_param.strength_target,iridix_param.iridix_global_DG);
