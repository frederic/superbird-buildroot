...
typedef void ( *gamma_std_frameid_func )( void *gamma_ctx, uint32_t frame_id );
typedef void ( *gamma_std_prev_param_func )( void *gamma_ctx, isp_gamma_preset_t * param );
...
typedef struct _gamma_std_obj_ {
    ...
    gamma_std_frameid_func frameid;
    gamma_std_prev_param_func prevparam;
} gamma_std_obj_t;
