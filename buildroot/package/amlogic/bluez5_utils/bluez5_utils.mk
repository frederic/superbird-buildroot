...
define BLUEZ5_UTILS_INSTALL_AML_TOOLS
	...
	$(INSTALL) -D -m 0755 package/amlogic/bluez5_utils/bluez_tool.sh $(TARGET_DIR)/usr/bin
	$(INSTALL) -D -m 0644 package/amlogic/bluez5_utils/main.conf $(TARGET_DIR)/etc/bluetooth
