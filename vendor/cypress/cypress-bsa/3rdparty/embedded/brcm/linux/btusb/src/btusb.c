...
#define BTUSB_VID_CYPRESS 0x04B4
...
static struct usb_device_id btusb_table [] =
{
    ...
    /* all CYPRESS vendor specific interfaces */
    { .match_flags = USB_DEVICE_ID_MATCH_VENDOR | USB_DEVICE_ID_MATCH_INT_CLASS | USB_DEVICE_ID_MATCH_INT_SUBCLASS |
            USB_DEVICE_ID_MATCH_INT_PROTOCOL,
      .idVendor = BTUSB_VID_CYPRESS,
      .bInterfaceClass = USB_CLASS_VENDOR_SPEC, //USB_CLASS_WIRELESS_CONTROLLER,
      /* 0x01 / 0x01 = Bluetooth programming interface */
      .bInterfaceSubClass = 0x01,
      .bInterfaceProtocol = 0x01
    },
    /* all CYPRESS vendor specific with Bluetooth programming interface */
    { .match_flags = USB_DEVICE_ID_MATCH_VENDOR | USB_DEVICE_ID_MATCH_DEV_CLASS |
            USB_DEVICE_ID_MATCH_DEV_SUBCLASS | USB_DEVICE_ID_MATCH_DEV_PROTOCOL,
      .idVendor = BTUSB_VID_CYPRESS,
      .bDeviceClass = USB_CLASS_VENDOR_SPEC,
...
MODULE_DESCRIPTION("Cypress Bluetooth USB driver");
MODULE_LICENSE("GPL");
