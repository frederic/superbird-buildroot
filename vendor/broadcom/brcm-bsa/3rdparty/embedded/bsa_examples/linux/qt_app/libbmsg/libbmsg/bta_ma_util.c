...
#define BTA_MSE_NOTIF_TYPE_READ_STATUS_CHANGED_STR  "ReadStatusChanged"
...
const char * bta_ma_evt_typ_to_string(tBTA_MSE_NOTIF_TYPE notif_type)
{
    switch (notif_type)
    {
        ...
        case BTA_MSE_NOTIF_TYPE_READ_STATUS_CHANGED:
            return(BTA_MSE_NOTIF_TYPE_READ_STATUS_CHANGED_STR);
    }
                                  ...
                                  tBTA_MA_STREAM * p_stream)
{
    ...
    while ( bta_ma_get_tag(p_stream, sz, BTA_MA_MAX_SIZE) )
    {
        ...
        {
            bta_ma_get_value(p_stream, sz, BTA_MA_MAX_SIZE);
            APPL_TRACE_WARNING1("bta_ma_parse_vcard - Unknown tag: '%s'", sz);
        }
    }
...
*/
#define BTA_MA_PARSE_BUF_SIZE   2100
                                 ...
                                 tBTA_MA_STREAM * p_stream)
{
    ...
    while ( bta_ma_get_tag(p_stream, sz, BTA_MA_MAX_SIZE) )
    {
        ...
        {
            bta_ma_get_value(p_stream, sz, BTA_MA_MAX_SIZE);
            APPL_TRACE_WARNING1("bta_ma_parse_body - Unknown tag: '%s'", sz);
        }
    }
