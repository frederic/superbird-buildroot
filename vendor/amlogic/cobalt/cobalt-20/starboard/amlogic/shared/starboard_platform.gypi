...
# limitations under the License.
{
  ...
  'variables': {
    ...
    'starboard_platform_sources': [
      ...
      '<(DEPTH)/third_party/starboard/amlogic/shared/media_is_transfer_characteristics_supported.cc',
...
#      '<(DEPTH)/starboard/shared/libaom/aom_video_decoder.h',
      ...
      '<!(ls <(DEPTH)/starboard/shared/pthread/thread_context_internal.cc 2>/dev/null || true)',
