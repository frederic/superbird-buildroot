...
# limitations under the License.
{
  ...
  'variables': {
    'starboard_platform_sources': [
      '<(DEPTH)/third_party/starboard/amlogic/directfb/main.cc',
      '<(DEPTH)/third_party/starboard/amlogic/directfb/system_get_property.cc',
      '<(DEPTH)/third_party/starboard/amlogic/directfb/player_output_mode_supported.cc',
      '<(DEPTH)/third_party/starboard/amlogic/directfb/application_directfb.cc',
      '<(DEPTH)/third_party/starboard/amlogic/directfb/blitter_create_swap_chain_from_window.cc',
