...
#ifndef THIRD_PARTY_STARBOARD_AMLOGIC_SHARED_DECODE_TARGET_INTERNAL_H_
#define THIRD_PARTY_STARBOARD_AMLOGIC_SHARED_DECODE_TARGET_INTERNAL_H_
...
#endif  // THIRD_PARTY_STARBOARD_AMLOGIC_SHARED_DECODE_TARGET_INTERNAL_H_
