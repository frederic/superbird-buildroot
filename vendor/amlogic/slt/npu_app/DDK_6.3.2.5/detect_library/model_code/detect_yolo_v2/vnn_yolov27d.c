...
vsi_nn_graph_t * vnn_CreateYolov27d
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    */
    attr.size[0] = 2320;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[0], attr, VSI_NN_TYPE_VDATA, 76048, 2320);
    ...
    */
    attr.size[0] = 20240;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[1], attr, VSI_NN_TYPE_VDATA, 376624, 20240);
    ...
    */
    attr.size[0] = 76048;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_VDATA, 50274464, 76048);
    ...
    */
    attr.size[0] = 10000;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[3], attr, VSI_NN_TYPE_VDATA, 396864, 10000);
    ...
    */
    attr.size[0] = 298256;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_VDATA, 406864, 298256);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_VDATA, 705120, 35088);
    ...
    */
    attr.size[0] = 298256;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_VDATA, 78368, 298256);
    ...
    */
    attr.size[0] = 1106384;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_VDATA, 740208, 1106384);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_VDATA, 1846592, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[10], attr, VSI_NN_TYPE_VDATA, 1981008, 1185040);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[11], attr, VSI_NN_TYPE_VDATA, 3166048, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_VDATA, 3300464, 1185040);
    ...
    */
    attr.size[0] = 34576;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_VDATA, 38239792, 34576);
    ...
    */
    attr.size[0] = 4345424;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[14], attr, VSI_NN_TYPE_VDATA, 4485504, 4345424);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[15], attr, VSI_NN_TYPE_VDATA, 8830928, 529680);
    ...
    */
    attr.size[0] = 4728080;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[16], attr, VSI_NN_TYPE_VDATA, 9360608, 4728080);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[17], attr, VSI_NN_TYPE_VDATA, 14088688, 529680);
    ...
    */
    attr.size[0] = 4728080;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[18], attr, VSI_NN_TYPE_VDATA, 14618368, 4728080);
    ...
    */
    attr.size[0] = 9446672;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[19], attr, VSI_NN_TYPE_VDATA, 19346448, 9446672);
    ...
    */
    attr.size[0] = 9446672;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[20], attr, VSI_NN_TYPE_VDATA, 28793120, 9446672);
    ...
    bias:   #BIAS_SHAPE#
            #BIAS_QUANTIZE_PARAMS#
    */
    attr.size[0] = 11610320;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[21], attr, VSI_NN_TYPE_VDATA, 38274368, 11610320);
    ...
    */
    attr.size[0] = 389776;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[22], attr, VSI_NN_TYPE_VDATA, 49884688, 389776);
...
error:
    ...
    vnn_ReleaseYolov27d( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolov27d() */

void vnn_ReleaseYolov27d
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
