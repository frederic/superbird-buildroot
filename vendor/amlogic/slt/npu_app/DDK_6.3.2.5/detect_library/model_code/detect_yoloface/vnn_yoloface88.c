...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    */
    attr.size[0] = 39876;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[1], attr, VSI_NN_TYPE_VDATA, 4036, 39876);
    ...
    */
    attr.size[0] = 151492;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_VDATA, 65255480, 151492);
    ...
    */
    attr.size[0] = 10000;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[3], attr, VSI_NN_TYPE_VDATA, 65406972, 10000);
    ...
    */
    attr.size[0] = 76048;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[4], attr, VSI_NN_TYPE_VDATA, 43912, 76048);
    ...
    */
    attr.size[0] = 278608;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_VDATA, 65416972, 278608);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_VDATA, 65695580, 35088);
    ...
    */
    attr.size[0] = 298256;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_VDATA, 119960, 298256);
    ...
    */
    attr.size[0] = 1090512;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_VDATA, 65730668, 1090512);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_VDATA, 418216, 134416);
    ...
    */
    attr.size[0] = 1181264;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[10], attr, VSI_NN_TYPE_VDATA, 552632, 1181264);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[11], attr, VSI_NN_TYPE_VDATA, 1733896, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_VDATA, 1868312, 1185040);
    ...
    */
    attr.size[0] = 4442768;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_VDATA, 3053352, 4442768);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[14], attr, VSI_NN_TYPE_VDATA, 7496120, 529680);
    ...
    */
    attr.size[0] = 4728080;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[15], attr, VSI_NN_TYPE_VDATA, 8025800, 4728080);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[16], attr, VSI_NN_TYPE_VDATA, 12753880, 529680);
    ...
    */
    attr.size[0] = 4725520;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[17], attr, VSI_NN_TYPE_VDATA, 13283560, 4725520);
    ...
    */
    attr.size[0] = 9446672;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[18], attr, VSI_NN_TYPE_VDATA, 18009080, 9446672);
    ...
    */
    attr.size[0] = 9446672;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[19], attr, VSI_NN_TYPE_VDATA, 27455752, 9446672);
    ...
    */
    ...
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[20], attr, VSI_NN_TYPE_VDATA, 36902424, 28321040);
    ...
    */
    attr.size[0] = 32016;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[21], attr, VSI_NN_TYPE_VDATA, 65223464, 32016);
...
error:
    ...
    vnn_ReleaseYoloFace88( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYoloFace88() */
