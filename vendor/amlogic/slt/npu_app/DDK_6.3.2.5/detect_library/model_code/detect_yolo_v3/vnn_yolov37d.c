...
vsi_nn_graph_t * vnn_CreateYolov37d
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    */
    attr.size[0] = 22480;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[1], attr, VSI_NN_TYPE_VDATA, 56786688, 22480);
    ...
    */
    attr.size[0] = 3344;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_VDATA, 58148832, 3344);
    ...
    */
    attr.size[0] = 18896;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[3], attr, VSI_NN_TYPE_VDATA, 2320, 18896);
    ...
    */
    attr.size[0] = 80720;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[4], attr, VSI_NN_TYPE_VDATA, 7794976, 80720);
    ...
    */
    attr.size[0] = 10000;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_VDATA, 29410496, 10000);
    ...
    */
    attr.size[0] = 72272;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_VDATA, 50631584, 72272);
    ...
    */
    attr.size[0] = 10000;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_VDATA, 55413616, 10000);
    ...
    */
    attr.size[0] = 73616;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_VDATA, 56118080, 73616);
    ...
    */
    attr.size[0] = 325072;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_VDATA, 56191696, 325072);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[10], attr, VSI_NN_TYPE_VDATA, 56516768, 35088);
    ...
    */
    attr.size[0] = 234832;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[11], attr, VSI_NN_TYPE_VDATA, 56551856, 234832);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_VDATA, 56809168, 35088);
    ...
    */
    attr.size[0] = 294224;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_VDATA, 56844256, 294224);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[14], attr, VSI_NN_TYPE_VDATA, 57138480, 35088);
    ...
    */
    attr.size[0] = 277840;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[15], attr, VSI_NN_TYPE_VDATA, 57173568, 277840);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[16], attr, VSI_NN_TYPE_VDATA, 57451408, 35088);
    ...
    */
    attr.size[0] = 294992;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[17], attr, VSI_NN_TYPE_VDATA, 57486496, 294992);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[18], attr, VSI_NN_TYPE_VDATA, 57781488, 35088);
    ...
    */
    attr.size[0] = 297168;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[19], attr, VSI_NN_TYPE_VDATA, 57816576, 297168);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[20], attr, VSI_NN_TYPE_VDATA, 58113744, 35088);
    ...
    */
    attr.size[0] = 293968;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[21], attr, VSI_NN_TYPE_VDATA, 58152176, 293968);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[22], attr, VSI_NN_TYPE_VDATA, 58446144, 35088);
    ...
    */
    attr.size[0] = 294928;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[23], attr, VSI_NN_TYPE_VDATA, 58481232, 294928);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[24], attr, VSI_NN_TYPE_VDATA, 58776160, 35088);
    ...
    */
    attr.size[0] = 298256;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[25], attr, VSI_NN_TYPE_VDATA, 58811248, 298256);
    ...
    */
    attr.size[0] = 1341968;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[26], attr, VSI_NN_TYPE_VDATA, 59109504, 1341968);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[27], attr, VSI_NN_TYPE_VDATA, 60451472, 134416);
    ...
    */
    attr.size[0] = 717200;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[28], attr, VSI_NN_TYPE_VDATA, 60585888, 717200);
    ...
    */
    attr.size[0] = 133840;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[29], attr, VSI_NN_TYPE_VDATA, 21216, 133840);
    ...
    */
    attr.size[0] = 1144016;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[30], attr, VSI_NN_TYPE_VDATA, 155056, 1144016);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[31], attr, VSI_NN_TYPE_VDATA, 1299072, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[32], attr, VSI_NN_TYPE_VDATA, 1433488, 1185040);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[33], attr, VSI_NN_TYPE_VDATA, 2618528, 134416);
    ...
    */
    attr.size[0] = 1150800;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[34], attr, VSI_NN_TYPE_VDATA, 2752944, 1150800);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[35], attr, VSI_NN_TYPE_VDATA, 3903744, 134416);
    ...
    */
    attr.size[0] = 1137872;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[36], attr, VSI_NN_TYPE_VDATA, 4038160, 1137872);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[37], attr, VSI_NN_TYPE_VDATA, 5176032, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[38], attr, VSI_NN_TYPE_VDATA, 5310448, 1185040);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[39], attr, VSI_NN_TYPE_VDATA, 6495488, 134416);
    ...
    */
    attr.size[0] = 1165072;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[40], attr, VSI_NN_TYPE_VDATA, 6629904, 1165072);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[41], attr, VSI_NN_TYPE_VDATA, 7875696, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[42], attr, VSI_NN_TYPE_VDATA, 8010112, 1185040);
    ...
    */
    attr.size[0] = 5559888;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[43], attr, VSI_NN_TYPE_VDATA, 9195152, 5559888);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[44], attr, VSI_NN_TYPE_VDATA, 14755040, 529680);
    ...
    */
    attr.size[0] = 4173136;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[45], attr, VSI_NN_TYPE_VDATA, 15284720, 4173136);
    ...
    */
    attr.size[0] = 521488;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[46], attr, VSI_NN_TYPE_VDATA, 19457856, 521488);
    ...
    */
    attr.size[0] = 4679888;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[47], attr, VSI_NN_TYPE_VDATA, 19979344, 4679888);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[48], attr, VSI_NN_TYPE_VDATA, 24659232, 529680);
    ...
    */
    attr.size[0] = 4221584;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[49], attr, VSI_NN_TYPE_VDATA, 25188912, 4221584);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[50], attr, VSI_NN_TYPE_VDATA, 29420496, 529680);
    ...
    */
    attr.size[0] = 4652176;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[51], attr, VSI_NN_TYPE_VDATA, 29950176, 4652176);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[52], attr, VSI_NN_TYPE_VDATA, 34602352, 529680);
    ...
    */
    attr.size[0] = 4728080;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[53], attr, VSI_NN_TYPE_VDATA, 35132032, 4728080);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[54], attr, VSI_NN_TYPE_VDATA, 39860112, 529680);
    ...
    */
    attr.size[0] = 4728080;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[55], attr, VSI_NN_TYPE_VDATA, 40389792, 4728080);
    ...
    */
    attr.size[0] = 529680;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[56], attr, VSI_NN_TYPE_VDATA, 45117872, 529680);
    ...
    */
    attr.size[0] = 4728080;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[57], attr, VSI_NN_TYPE_VDATA, 45647552, 4728080);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[58], attr, VSI_NN_TYPE_VDATA, 50703856, 134416);
    ...
    */
    attr.size[0] = 255952;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[59], attr, VSI_NN_TYPE_VDATA, 50375632, 255952);
    ...
    */
    attr.size[0] = 199952;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[60], attr, VSI_NN_TYPE_VDATA, 50838272, 199952);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[61], attr, VSI_NN_TYPE_VDATA, 51038224, 1185040);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[62], attr, VSI_NN_TYPE_VDATA, 52223264, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[63], attr, VSI_NN_TYPE_VDATA, 52357680, 1185040);
    ...
    */
    attr.size[0] = 134416;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[64], attr, VSI_NN_TYPE_VDATA, 53542720, 134416);
    ...
    */
    attr.size[0] = 1185040;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[65], attr, VSI_NN_TYPE_VDATA, 53677136, 1185040);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[66], attr, VSI_NN_TYPE_VDATA, 54993712, 35088);
    ...
    */
    attr.size[0] = 131536;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[67], attr, VSI_NN_TYPE_VDATA, 54862176, 131536);
    ...
    */
    attr.size[0] = 51472;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[68], attr, VSI_NN_TYPE_VDATA, 55028800, 51472);
    ...
    */
    attr.size[0] = 298256;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[69], attr, VSI_NN_TYPE_VDATA, 55080272, 298256);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[70], attr, VSI_NN_TYPE_VDATA, 55378528, 35088);
    ...
    */
    attr.size[0] = 298256;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[71], attr, VSI_NN_TYPE_VDATA, 55423616, 298256);
    ...
    */
    attr.size[0] = 35088;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[72], attr, VSI_NN_TYPE_VDATA, 55721872, 35088);
    ...
    */
    attr.size[0] = 294224;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[73], attr, VSI_NN_TYPE_VDATA, 55756960, 294224);
    ...
    */
    attr.size[0] = 66896;
    attr.dim_num = 1;
    NEW_CONST_TENSOR(const_tensor[74], attr, VSI_NN_TYPE_VDATA, 56051184, 66896);
...
error:
    ...
    vnn_ReleaseYolov37d( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolov37d() */

void vnn_ReleaseYolov37d
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
