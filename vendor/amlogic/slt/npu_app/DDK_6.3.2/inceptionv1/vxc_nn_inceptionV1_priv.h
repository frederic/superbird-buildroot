/*******************************************************************************
 * Name        : vxc_nn_inceptionV1_priv.h
 * Author      : Your name
 * Copyright   : Your copyright notice
 * Description : Neural network private header file generated by VivanteIDE
 *******************************************************************************/
#ifndef VXC_NN_INCEPTIONV1_PRIV_H
#define VXC_NN_INCEPTIONV1_PRIV_H
...
typedef struct tensor_permute_info
{
    tensor_split_info_t         tensor_split_info;

    vx_graph                    graph;
    vx_tensor                   input;
    vx_uint32                   perm[NN_TENSOR_MAX_DIMENSION];
    tensor_format_info_t        output_format;
    vx_bool                     output_layer;

    vx_tensor                   output;
    vx_node                     node;
} tensor_permute_info_t;
...
typedef struct tensor_reshape_info
{
    tensor_split_info_t         tensor_split_info;

    vx_graph                    graph;
    vx_tensor                   input;
    vx_int32                    shape[NN_TENSOR_MAX_DIMENSION];
...
#endif //VXC_NN_INCEPTIONV1_PRIV_H
