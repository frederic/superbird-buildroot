...
export AQROOT=$1/output/$2/build/npu
...
export VIVANTE_SDK_LIB=$AQROOT/sharelib
...
arm-fsl)
    ...
    export OPENCV_ROOT=$1/output/$2/build/opencv-2.4.13
    export OVXLIB_DIR=$1/output/$2/target/usr	
    export CROSS_COMPILE=aarch64-linux-gnu-
    export TOOLCHAIN=$1/toolchain/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.02-x86_64_aarch64-linux-gnu/bin
    export LIB_DIR=$1/toolchain/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.02-x86_64_aarch64-linux-gnu/aarch64-linux-gnu/libc/lib
