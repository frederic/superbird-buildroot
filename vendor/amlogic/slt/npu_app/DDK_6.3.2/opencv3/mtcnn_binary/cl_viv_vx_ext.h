...
#define VXC_AtomicS(BaseAddr, Offsets, Data, AtomicSInfo)              VXC_OP4(atomic_s, BaseAddr, Offsets, Data, AtomicSInfo)
#define VXC_AtomicS_b(BaseAddr, Offsets, Offsets_b, Data, AtomicSInfo) VXC_OP5(atomic_s_b, BaseAddr, Offsets, Offsets_b, Data, AtomicSInfo)
