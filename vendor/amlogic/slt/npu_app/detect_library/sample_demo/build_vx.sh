...
export AQROOT=/mnt/fileroot/deng.liu/liu/basesrc-6.3.2.5
...
export OUTPUT_DIR=/mnt/fileroot/deng.liu/base/output/mesong12b_skt_release/target/usr/lib
...
arm-fsl)
    ...
    export OPENCV_ROOT=/mnt/fileroot/deng.liu/base/output/mesong12b_skt_release/build/opencv3-3.4.3

    export CROSS_COMPILE=aarch64-linux-gnu-
    export TOOLCHAIN=/mnt/fileroot/deng.liu/base/toolchain/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.02-x86_64_aarch64-linux-gnu/bin
