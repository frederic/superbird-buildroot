...
#define NET_CONST_TENSOR_NUM    (44)
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[0], VSI_NN_OP_CONV_RELU_POOL, 3, 1, 5);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[2], VSI_NN_OP_CONV_RELU_POOL, 3, 1, 10);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[4], VSI_NN_OP_CONV_RELU, 3, 1, 11);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[104, 104, 64, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[6], VSI_NN_OP_CONV_RELU, 3, 1, 15);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[8], VSI_NN_OP_CONV_RELU_POOL, 3, 1, 23);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[10], VSI_NN_OP_CONV_RELU, 3, 1, 24);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[52, 52, 128, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[12], VSI_NN_OP_CONV_RELU, 3, 1, 28);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[14], VSI_NN_OP_CONV_RELU_POOL, 3, 1, 36);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[16], VSI_NN_OP_CONV_RELU, 3, 1, 37);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[26, 26, 256, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[18], VSI_NN_OP_CONV_RELU, 3, 1, 41);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[26, 26, 512, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[20], VSI_NN_OP_CONV_RELU, 3, 1, 45);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[26, 26, 256, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[22], VSI_NN_OP_CONV_RELU, 3, 1, 49);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[26, 26, 512, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[24], VSI_NN_OP_CONV_RELU, 3, 1, 53);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[28], VSI_NN_OP_CONV_RELU, 3, 1, 58);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 512, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[30], VSI_NN_OP_CONV_RELU, 3, 1, 62);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 1024, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[32], VSI_NN_OP_CONV_RELU, 3, 1, 66);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 512, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[34], VSI_NN_OP_CONV_RELU, 3, 1, 70);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 1024, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[36], VSI_NN_OP_CONV_RELU, 3, 1, 74);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 1024, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[38], VSI_NN_OP_CONV_RELU, 3, 1, 78);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 1024, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[40], VSI_NN_OP_CONV_RELU, 3, 1, 82);
    ...
    /*-----------------------------------------
      ...
      out_shape - [[13, 13, 1024, 1]]
    -----------------------------------------*/
    NEW_VXNODE(node[43], VSI_NN_OP_CONV_RELU, 3, 1, 88);
    ...
    -----------------------------------------*/
    NEW_VXNODE(node[45], VSI_NN_OP_CONV_RELU, 3, 1, 92);
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.dtype.fl = 7;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_INT8, 1248, 18432);

    /* @conv2_6_pool2_10:bias */
    attr.size[0] = 64;
    attr.dim_num = 1;
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    ...
    attr.dtype.fl = 8;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[4], attr, VSI_NN_TYPE_INT8, 65467736, 73728);
    ...
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_INT32, 65467224, 512);

    /* @trans_conv4_15:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 128;
    attr.size[3] = 64;
    ...
    attr.dtype.fl = 6;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_INT8, 65541720, 8192);
    ...
    attr.dtype.fl = 9;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_INT32, 65541464, 256);

    /* @conv5_19_pool5_23:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 64;
    attr.size[3] = 128;
    ...
    attr.dtype.fl = 7;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_INT8, 20192, 73728);

    /* @conv5_19_pool5_23:bias */
    attr.size[0] = 128;
    attr.dim_num = 1;
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_INT32, 19680, 512);

    /* @trans_conv6_24:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 128;
    attr.size[3] = 256;
    ...
    attr.dtype.fl = 7;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[10], attr, VSI_NN_TYPE_INT8, 65550936, 294912);
    ...
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[11], attr, VSI_NN_TYPE_INT32, 65549912, 1024);

    /* @trans_conv7_28:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 256;
    attr.size[3] = 128;
    ...
    attr.dtype.fl = 6;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_INT8, 65846360, 32768);
    ...
    attr.dtype.fl = 9;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_INT32, 65845848, 512);

    /* @conv8_32_pool8_36:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 128;
    attr.size[3] = 256;
    ...
    attr.dtype.fl = 8;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[14], attr, VSI_NN_TYPE_INT8, 94944, 294912);

    /* @conv8_32_pool8_36:bias */
    attr.size[0] = 256;
    attr.dim_num = 1;
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[15], attr, VSI_NN_TYPE_INT32, 93920, 1024);

    /* @trans_conv9_37:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 256;
    attr.size[3] = 512;
    ...
    attr.dtype.fl = 7;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[16], attr, VSI_NN_TYPE_INT8, 65881176, 1179648);
    ...
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[17], attr, VSI_NN_TYPE_INT32, 65879128, 2048);

    /* @trans_conv10_41:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 512;
    attr.size[3] = 256;
    ...
    attr.dtype.fl = 6;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[18], attr, VSI_NN_TYPE_INT8, 390880, 131072);

    /* @trans_conv10_41:bias */
    attr.size[0] = 256;
    attr.dim_num = 1;
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[19], attr, VSI_NN_TYPE_INT32, 389856, 1024);

    /* @trans_conv11_45:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 256;
    attr.size[3] = 512;
    ...
    attr.dtype.fl = 8;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[20], attr, VSI_NN_TYPE_INT8, 524000, 1179648);

    /* @trans_conv11_45:bias */
    attr.size[0] = 512;
    attr.dim_num = 1;
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[21], attr, VSI_NN_TYPE_INT32, 521952, 2048);

    /* @trans_conv12_49:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 512;
    attr.size[3] = 256;
    ...
    attr.dtype.fl = 6;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[22], attr, VSI_NN_TYPE_INT8, 1704672, 131072);

    /* @trans_conv12_49:bias */
    attr.size[0] = 256;
    attr.dim_num = 1;
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[23], attr, VSI_NN_TYPE_INT32, 1703648, 1024);

    /* @trans_conv13_53:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 256;
    attr.size[3] = 512;
    ...
    attr.dtype.fl = 8;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[24], attr, VSI_NN_TYPE_INT8, 1837792, 1179648);

    /* @trans_conv13_53:bias */
    attr.size[0] = 512;
    attr.dim_num = 1;
    attr.dtype.fl = 12;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[25], attr, VSI_NN_TYPE_INT32, 1835744, 2048);

    /* @trans_conv14_58:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 512;
    attr.size[3] = 1024;
    ...
    attr.dtype.fl = 7;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[26], attr, VSI_NN_TYPE_INT8, 3021536, 4718592);

    /* @trans_conv14_58:bias */
    attr.size[0] = 1024;
    attr.dim_num = 1;
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[27], attr, VSI_NN_TYPE_INT32, 3017440, 4096);

    /* @trans_conv15_62:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 1024;
    attr.size[3] = 512;
    ...
    attr.dtype.fl = 5;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[28], attr, VSI_NN_TYPE_INT8, 7742176, 524288);

    /* @trans_conv15_62:bias */
    attr.size[0] = 512;
    attr.dim_num = 1;
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[29], attr, VSI_NN_TYPE_INT32, 7740128, 2048);

    /* @trans_conv16_66:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 512;
    attr.size[3] = 1024;
    ...
    attr.dtype.fl = 8;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[30], attr, VSI_NN_TYPE_INT8, 8270560, 4718592);

    /* @trans_conv16_66:bias */
    attr.size[0] = 1024;
    attr.dim_num = 1;
    attr.dtype.fl = 12;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[31], attr, VSI_NN_TYPE_INT32, 8266464, 4096);

    /* @trans_conv17_70:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 1024;
    attr.size[3] = 512;
    ...
    attr.dtype.fl = 6;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[32], attr, VSI_NN_TYPE_INT8, 12991200, 524288);

    /* @trans_conv17_70:bias */
    attr.size[0] = 512;
    attr.dim_num = 1;
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[33], attr, VSI_NN_TYPE_INT32, 12989152, 2048);

    /* @trans_conv18_74:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 512;
    attr.size[3] = 1024;
    ...
    attr.dtype.fl = 5;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[34], attr, VSI_NN_TYPE_INT8, 13519584, 4718592);

    /* @trans_conv18_74:bias */
    attr.size[0] = 1024;
    attr.dim_num = 1;
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[35], attr, VSI_NN_TYPE_INT32, 13515488, 4096);

    /* @trans_conv19_78:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 1024;
    attr.size[3] = 1024;
    ...
    attr.dtype.fl = 12;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[36], attr, VSI_NN_TYPE_INT8, 18242272, 9437184);

    /* @trans_conv19_78:bias */
    attr.size[0] = 1024;
    attr.dim_num = 1;
    attr.dtype.fl = 14;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[37], attr, VSI_NN_TYPE_INT32, 18238176, 4096);

    /* @trans_conv20_82:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 1024;
    attr.size[3] = 1024;
    ...
    attr.dtype.fl = 11;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[38], attr, VSI_NN_TYPE_INT8, 27683552, 9437184);

    /* @trans_conv20_82:bias */
    attr.size[0] = 1024;
    attr.dim_num = 1;
    attr.dtype.fl = 15;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[39], attr, VSI_NN_TYPE_INT32, 27679456, 4096);

    /* @trans_conv21_88:weight */
    attr.size[0] = 3;
    attr.size[1] = 3;
    attr.size[2] = 3072;
    attr.size[3] = 1024;
    ...
    attr.dtype.fl = 10;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[40], attr, VSI_NN_TYPE_INT8, 37124832, 28311552);

    /* @trans_conv21_88:bias */
    attr.size[0] = 1024;
    attr.dim_num = 1;
    attr.dtype.fl = 14;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[41], attr, VSI_NN_TYPE_INT32, 37120736, 4096);

    /* @trans_conv22_92:weight */
    attr.size[0] = 1;
    attr.size[1] = 1;
    attr.size[2] = 1024;
    attr.size[3] = 30;
    ...
    attr.dtype.fl = 9;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[42], attr, VSI_NN_TYPE_INT8, 65436504, 30720);

    /* @trans_conv22_92:bias */
    attr.size[0] = 30;
    attr.dim_num = 1;
    attr.dtype.fl = 14;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_CONST_TENSOR(const_tensor[43], attr, VSI_NN_TYPE_INT32, 65436384, 120);
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[20]->input.tensors[1] = const_tensor[20]; /* data_weight */
    node[20]->input.tensors[2] = const_tensor[21]; /* data_bias */
    ...
    node[22]->input.tensors[1] = const_tensor[22]; /* data_weight */
    node[22]->input.tensors[2] = const_tensor[23]; /* data_bias */
    ...
    node[24]->input.tensors[1] = const_tensor[24]; /* data_weight */
    node[24]->input.tensors[2] = const_tensor[25]; /* data_bias */
    ...
    node[30]->input.tensors[1] = const_tensor[28]; /* data_weight */
    node[30]->input.tensors[2] = const_tensor[29]; /* data_bias */
    ...
    node[34]->input.tensors[1] = const_tensor[32]; /* data_weight */
    node[34]->input.tensors[2] = const_tensor[33]; /* data_bias */
    ...
    node[36]->input.tensors[1] = const_tensor[34]; /* data_weight */
    node[36]->input.tensors[2] = const_tensor[35]; /* data_bias */
    ...
    node[38]->input.tensors[1] = const_tensor[36]; /* data_weight */
    node[38]->input.tensors[2] = const_tensor[37]; /* data_bias */
    ...
    node[40]->input.tensors[1] = const_tensor[38]; /* data_weight */
    node[40]->input.tensors[2] = const_tensor[39]; /* data_bias */
    ...
    node[43]->input.tensors[1] = const_tensor[40]; /* data_weight */
    node[43]->input.tensors[2] = const_tensor[41]; /* data_bias */
