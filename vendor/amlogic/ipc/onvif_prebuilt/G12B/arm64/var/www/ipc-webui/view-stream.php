...
<script type="text/javascript" src="scripts/mp4-generator-mini.js"></script>
...
//                duration:-1,
    ...
    var wsurl = 'ws://' + document.location.hostname + ':' + <?php echo ipc_property("get", "/ipc/video/ts/web/port") ?> + '/';
    var vidElement;
    var player;
    var show_fps = false;
