 ...
 */
    ...
    #include "pager.h"
        ...
        extern int sqlite3_iMallocFail; /* Fail sqliteMalloc() after this many
            calls */
        extern int sqlite3_iMallocReset; /* Set iMallocFail to this when it
            reaches 0 */
        ...
        extern int sqlite3_mallocDisallowed; /* assert() in sqlite3Malloc() if
            set */
        extern int sqlite3_isFail; /* True if all malloc calls should fail */
        extern const char *sqlite3_zFile; /* Filename to associate debug info
            with */
        extern int sqlite3_iLine; /* Line number for debug info */

        #define ENTER_MALLOC (sqlite3_zFile = __FILE__, sqlite3_iLine =
            __LINE__)
        ...
        #define sqliteReallocOrFree(x,y) (ENTER_MALLOC, sqlite3ReallocOrFree(x,
            y))
    ...
    struct ThreadData
    {
        int dummy; /* So that this structure is never empty */
            ...
            int nSoftHeapLimit; /* Suggested max mem allocation.  No limit if
                <0 */
     ...
     */
    #define SCHEMA_TABLE(x)  ((!OMIT_TEMPDB)&&(x==1)?TEMP_MASTER_NAME
        :MASTER_NAME)
    ...
    #define SQLITE_InternChanges  0x00000010  /* Uncommitted Hash table changes
        */
    #define SQLITE_FullColNames   0x00000020  /* Show full column names on
        SELECT */
    ...
    #define SQLITE_NullCallback   0x00000100  /* Invoke the callback once if
        the */
    /*   result set is empty */
    ...
    #define SQLITE_LegacyFileFmt  0x00008000  /* Create new databases in format
        1 */
    ...
    #define SQLITE_MAGIC_ERROR    0xb5357930  /* An SQLITE_MISUSE error
        occurred */
    ...
    struct FuncDef
    {
        ...
        void(*xFunc)(sqlite3_context *, int, sqlite3_value **); /* Regular
            function */
        void(*xStep)(sqlite3_context *, int, sqlite3_value **); /* Aggregate
            step */
    ...
    struct Table
    {
        ...
        char *zColAff; /* String defining the affinity of each column */
            ...
            int addColOffset; /* Offset in CREATE TABLE statement to add a new
                column */
        #endif
        Schema *pSchema;
    };
    ...
    struct Index
    {
        ...
        unsigned *aiRowEst; /* Result of ANALYZE: Est. rows selected by each
            column */
    ...
    struct Expr
    {
        ...
        int iTable, iColumn; /* When op==TK_COLUMN, then this expr node means
            the
    ...
    struct SrcList
    {
        ...
        struct SrcList_item
        {
            ...
            char *zName; /* Name of the table */
            char *zAlias; /* The "B" part of a "A AS B" phrase.  zName is the
                "A" */
            Table *pTab; /* An SQL table corresponding to zName */
            Select *pSelect; /* A SELECT statement used in place of a table
                name */
            u8 isPopulated; /* Temporary table associated with SELECT is
                populated */
    ...
    #define SRT_Table        7  /* Store result as data with an automatic rowid
        */
    #define SRT_VirtualTab   8  /* Create virtual table and store like
        SRT_Table */
    ...
    struct Parse
    {
        ...
        int cookieValue[MAX_ATTACHED + 2]; /* Values of cookies to verify */
            ...
            TableLock *aTableLock; /* Required table locks for shared-cache
                mode */
        #endif
    ...
    struct TriggerStep
    {
        ...
        TriggerStep *pLast; /* Last element in link-list. Valid for 1st elem
            only */
    };
    ...
    struct DbFixer
    {
        ...
        const char *zDb; /* Make sure all objects are contained in this
            database */
    ...
    void sqlite3EndTable(Parse *, Token *, Token *, Select*);
        ...
        void sqlite3CreateView(Parse *, Token *, Token *, Token *, Select *,
            int);
    ...
    int sqlite3Select(Parse *, Select *, int, int, Select *, int, int *, char
        *aff);
    Select *sqlite3SelectNew(ExprList *, SrcList *, Expr *, ExprList *, Expr *,
    ...
    void sqlite3GenerateConstraintChecks(Parse *, Table *, int, char *, int,
        int, int, int);
    ...
    void sqlite3ChangeCookie(sqlite3 *, Vdbe *, int);
        ...
        void sqlite3BeginTrigger(Parse *, Token *, Token *, int, int, IdList *,
            SrcList *, int, Expr *, int);
        void sqlite3FinishTrigger(Parse *, TriggerStep *, Token*);
        void sqlite3DropTrigger(Parse *, SrcList*);
        void sqlite3DropTriggerPtr(Parse *, Trigger*);
        int sqlite3TriggersExist(Parse *, Table *, int, ExprList*);
        int sqlite3CodeRowTrigger(Parse *, int, ExprList *, int, Table *, int,
            int, int, int);
    ...
    void sqlite3DeferForeignKey(Parse *, int);
        ...
        int sqlite3AuthCheck(Parse *, int, const char *, const char *, const
            char*);
    ...
    int sqlite3BtreeFactory(const sqlite3 *db, const char *zFilename, int
        omitJournal, int nCache, Btree **ppBtree);
    ...
    void sqlite3ValueSetStr(sqlite3_value *, int, const void *, u8, void(*)
        (void*));
    ...
    int sqlite3CreateFunc(sqlite3 *, const char *, int, int, void *, void(*)
        (sqlite3_context *, int, sqlite3_value **), void(*)(sqlite3_context *,
        int, sqlite3_value **), void(*)(sqlite3_context*));
