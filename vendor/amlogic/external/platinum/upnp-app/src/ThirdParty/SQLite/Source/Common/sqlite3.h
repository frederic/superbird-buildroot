 ...
 */
     ...
     */
        ...
        #define SQLITE_INTERNAL     2   /* NOT USED. Internal logic error in
            SQLite */
        ...
        #define SQLITE_RANGE       25   /* 2nd parameter to sqlite3_bind out of
            range */
        #define SQLITE_NOTADB      26   /* File opened that is not a database
            file */
        ...
        char *sqlite3_snprintf(int, char *, const char *, ...);
             ...
             */
            int sqlite3_set_authorizer(sqlite3 *, int(*xAuth)(void *, int,
        ...
        #define SQLITE_INSERT               18   /* Table Name      NULL
            */
        #define SQLITE_PRAGMA               19   /* Pragma Name     1st arg or
            NULL */
         ...
         ** returned.
         */
        int sqlite3_create_function(sqlite3 *, const char *zFunctionName, int
            nArg, int eTextRep, void *, void(*xFunc)(sqlite3_context *, int,
            sqlite3_value **), void(*xStep)(sqlite3_context *, int,
            sqlite3_value **), void(*xFinal)(sqlite3_context*));
        int sqlite3_create_function16(sqlite3 *, const void *zFunctionName, int
            nArg, int eTextRep, void *, void(*xFunc)(sqlite3_context *, int,
            sqlite3_value **), void(*xStep)(sqlite3_context *, int,
            sqlite3_value **), void(*xFinal)(sqlite3_context*));
        ...
        int sqlite3_create_collation(sqlite3 *, const char *zName, int eTextRep,
            ...
            ;
        int sqlite3_create_collation16(sqlite3 *, const char *zName, int
            eTextRep, void *, int(*xCompare)(void *, int, const void *, int,
            const void*));
        ...
        int sqlite3_collation_needed16(sqlite3 *, void *, void(*)(void *,
