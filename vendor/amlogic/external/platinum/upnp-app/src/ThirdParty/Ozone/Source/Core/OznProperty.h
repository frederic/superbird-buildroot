...
public:
    ...
    // accessor methods
    OZN_PropertyType         GetType()
    {
        return OZN_PROPERTY_TYPE_INTEGER;
    }
...
public:
    ...
    OZN_PropertyType         GetType()
    {
        return OZN_PROPERTY_TYPE_STRING;
    }
    const OZN_PropertyValue &GetValue();
    NPT_Result               SetValue ( const OZN_PropertyValue *value );
...
public:
    ...
    const NPT_Array<OZN_Property *> &GetProperties() const
    {
        return m_Properties;
    }
